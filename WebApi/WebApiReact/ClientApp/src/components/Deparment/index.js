...
{
alert("Đăng nhập để xem thông tin")
}
else{
    fetchDeparment();
}
                ...
                <tr key={key}>
                    ...
                    <td>
                        ...
                        <Button variant="warning">
                            <i className='bx bx-edit'>Sửa</i></Button>
                        </Link>
                    </td>
                    <td>
                        <Button variant="danger" onClick={()=> {
                            let check = window.confirm(`Ban co chac xoa id: ${item.departmentId} - ten:
                            ${item.departmentName}?`)
                            // alert(check)
                            if (check)
                            ...
                            >
                            <i className="bi bi-trash">Xóa</i></Button>
                    </td>
