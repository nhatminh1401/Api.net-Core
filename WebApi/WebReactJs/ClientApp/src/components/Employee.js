...
/*Import api */
import { GET_ALL_CATEGORIES, POST_ADD_Employee } from '../api/apiService';
...
export default function Employee() {
    ...
    /* SET ATTRIBUTE FORM ADD Employee */
  ...
  const handleChangeTitle = (event) => {
    ...
    /* EVENT BUTTON SUBMIT FORM ADD Employee */
    const addEmployee = (event) => {
        ...
        if (title !== "" && body !== "" && slug !== "" && category > 0) {
            ...
            POST_ADD_Employee(`Employees`, Employee).then(item => {
                if (item.data === 1) {
                    setCheckAdd(true);
                }
            })
                ...
                <Grid item xs={12}>
                    <Paper className={classes.paper}>
                        ...
                        <Grid item xs={12} sm container>
                            ...
                            <Grid item xs={12}>
                                <Button type="button" onClick={addEmployee} fullWidth variant="contained" color="primary" className={classes.submit} >
                                    Add Employee
                                </Button>
                            </Grid>
                        </Grid>
